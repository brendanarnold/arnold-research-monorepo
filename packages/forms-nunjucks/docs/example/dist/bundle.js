    ...
    static fromJson(json, builders) {
        ...
        const isRequired = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.isBoolean)(json.isRequired)
            ...
            : (_a = builders.dataTriggers
                .find((dt) => dt.name === json.isRequired.name)) === null || _a === void 0 ? void 0 : _a.fromJson(json.isRequired);
    ...
    static fromJson(json, builders) {
        ...
        fieldSet.validations = json.validations.map((vJson) => {
            ...
            return (_a = builders.validations
                .find((v) => v.name === vJson.name)) === null || _a === void 0 ? void 0 : _a.fromJson(vJson, builders.validations);
        });
...
class FormsBuilder {
    constructor() {
        this.builders = { validations: [], dataTriggers: [] };
    }
    with(plugin) {
